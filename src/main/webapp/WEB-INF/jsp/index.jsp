...
<div class="bootstrap-wrapper" style="padding-top: 5%">
	...
	<section class="services">
        <div class="container text-center py-5">
                <h1 class="py-2">About Our Services</h1>
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <i class="fa fa-bar-chart" style="font-size: 5rem;padding: 2rem;"></i>
      ...
      <section class="message py-5" style="background: linear-gradient( to top , #fad0c4 0% , #ffd1ff 100%);">
        <div class="container text-center">
            ...
            <a href="/signup" class="btn btn-success">Explore Here</a>
        </div>
      </section>
</div>
